...
echo -e $g"▒▒▒   ▒▒▒   ▒▒▒   ▒▒▒   ▒▒▒   ▒▒▒   ▒▒▒    "   
echo -e $g"  MR▒▒▒  C▒▒▒  R▒▒▒ A ▒▒▒  C ▒▒▒  KED ▒▒▒   "
echo -e $g"▒▒▒   ▒▒▒   ▒▒▒   ▒▒▒   ▒▒▒   ▒▒▒   ▒▒▒           " 
echo -e $bl"."
echo -e $bu "________________________________________"
echo -e $bu  " Tools       : VIP$white          " 
echo -e $bu  " Author      : MR.ℭℜɑℭƙℰɗ $white  " 
echo -e $bu  " Contact     : 08567421776 $white " 
...
0) echo -e $bu"WIBU-" 
echo -e $bu"THANK'S"
printf "\e[103m\e[1;77mBY; MR.CRACKED\e[0m\n"
sleep 2
exit
;;

*) echo "PILIH YG BENER KNTL !!"  | lolcat
esac
done
done
